...
public class XinziEntity<T> implements Serializable {
     ...
     * 人事
     */
    @TableField(value = "caiwurenyuan_id")

    private Integer caiwurenyuanId;
	 ...
	 * 设置：人事
	 */
    public Integer getCaiwurenyuanId() {
        return caiwurenyuanId;
    }
    ...
    public void setCaiwurenyuanId(Integer caiwurenyuanId) {
        this.caiwurenyuanId = caiwurenyuanId;
    }
    /**
	 * 设置：员工
	 */
