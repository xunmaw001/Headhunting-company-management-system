    ...
    */
    ...
    public R save(@RequestBody CaiwurenyuanEntity caiwurenyuan, HttpServletRequest request){
        ...
        if(caiwurenyuanEntity==null){
            caiwurenyuan.setInsertTime(new Date());
...
//                            caiwurenyuanEntity.setRuzhiTime(new Date(data.get(0)));          //入职时间 要改的
//                            caiwurenyuanEntity.setInsertTime(date);//时间
...
//    	ValidatorUtils.validateEntity(user);
    ...
    */
    ...
    public R add(@RequestBody CaiwurenyuanEntity caiwurenyuan, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,caiwurenyuan:{}",this.getClass().getName(),caiwurenyuan.toString());
        Wrapper<CaiwurenyuanEntity> queryWrapper = new EntityWrapper<CaiwurenyuanEntity>()
            .eq("username", caiwurenyuan.getUsername())
            .or()
            .eq("caiwurenyuan_phone", caiwurenyuan.getCaiwurenyuanPhone())
