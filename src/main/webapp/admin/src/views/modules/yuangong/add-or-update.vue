               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="普通员工姓名" prop="yuangongName">
                       <el-input v-model="ruleForm.yuangongName"
                                 placeholder="普通员工姓名" clearable  :readonly="ro.yuangongName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="普通员工手机号" prop="yuangongPhone">
                       <el-input v-model="ruleForm.yuangongPhone"
                                 placeholder="普通员工手机号" clearable  :readonly="ro.yuangongPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="普通员工身份证号" prop="yuangongIdNumber">
                       <el-input v-model="ruleForm.yuangongIdNumber"
                                 placeholder="普通员工身份证号" clearable  :readonly="ro.yuangongIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家庭住址" prop="yuangongZhuzhi">
                       <el-input v-model="ruleForm.yuangongZhuzhi"
                                 placeholder="家庭住址" clearable  :readonly="ro.yuangongZhuzhi"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yuangongEmail: false,
                    jiguan: false,
                    yuangongZhuzhi: false,
                    ruzhiTime: false,
                    insertTime: false,
                    yuangongDelete: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   yuangongName: [
                              { required: true, message: '普通员工姓名不能为空', trigger: 'blur' },
                          ],
                   yuangongPhone: [
                              {  required: true, message: '普通员工手机号不能为空', trigger: 'blur' },
                   ...
                   yuangongIdNumber: [
                              { required: true, message: '普通员工身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '普通员工身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   yuangongPhoto: [
                              { required: true, message: '普通员工头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
