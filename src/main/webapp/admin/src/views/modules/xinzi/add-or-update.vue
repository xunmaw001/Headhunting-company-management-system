<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='caiwurenyuan'">
                    <el-form-item class="select" v-if="type!='info'"  label="财务人员" prop="caiwurenyuanId">
                        <el-select v-model="ruleForm.caiwurenyuanId" :disabled="ro.caiwurenyuanId" filterable placeholder="请选择财务人员" @change="caiwurenyuanChange">
                            <el-option
                                    v-for="(item,index) in caiwurenyuanOptions"
                                    v-bind:key="item.id"
                                    :label="item.caiwurenyuanName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='caiwurenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="财务人员姓名" prop="caiwurenyuanName">
                        <el-input v-model="caiwurenyuanForm.caiwurenyuanName"
                                  placeholder="财务人员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="财务人员姓名" prop="caiwurenyuanName">
                            <el-input v-model="ruleForm.caiwurenyuanName"
                                      placeholder="财务人员姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='caiwurenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="财务人员手机号" prop="caiwurenyuanPhone">
                        <el-input v-model="caiwurenyuanForm.caiwurenyuanPhone"
                                  placeholder="财务人员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="财务人员手机号" prop="caiwurenyuanPhone">
                            <el-input v-model="ruleForm.caiwurenyuanPhone"
                                      placeholder="财务人员手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='caiwurenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="财务人员身份证号" prop="caiwurenyuanIdNumber">
                        <el-input v-model="caiwurenyuanForm.caiwurenyuanIdNumber"
                                  placeholder="财务人员身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="财务人员身份证号" prop="caiwurenyuanIdNumber">
                            <el-input v-model="ruleForm.caiwurenyuanIdNumber"
                                      placeholder="财务人员身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='caiwurenyuan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.caiwurenyuanPhoto" label="财务人员头像" prop="caiwurenyuanPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (caiwurenyuanForm.caiwurenyuanPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.caiwurenyuanPhoto" label="财务人员头像" prop="caiwurenyuanPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.caiwurenyuanPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="caiwurenyuanId" name="caiwurenyuanId" type="hidden">
            <input id="yuangongId" name="yuangongId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="月份" prop="xinziMonth">
                       <el-input type="month" v-model="ruleForm.xinziMonth"
               ...
               <el-col :span="12" v-if="type=='info'" >
                   ...
                   <div>
                       <el-form-item class="input" label="实发" prop="shifaJine">
                           <el-input v-model="ruleForm.shifaJine"
                                     placeholder="实发" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="xinziContent">
    ...
    export default {
        data() {
            return {
                ...
                yuangongForm: {},
                ro:{
                    caiwurenyuanId: false,
                    yuangongId: false,
                    xinziUuidNumber: false,
                    xinziName: false,
                    xinziMonth: false,
                    jibenJine: false,
                    jiangjinJine: false,
                ...
                rules: {
                   caiwurenyuanId: [
                              { required: true, message: '人事不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `caiwurenyuan/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.caiwurenyuanOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            caiwurenyuanChange(id){
                this.$http({
                    url: `caiwurenyuan/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.caiwurenyuanForm = data.data;
                    }
                });
            },
            yuangongChange(id){
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.caiwurenyuanChange(data.data.caiwurenyuanId)
